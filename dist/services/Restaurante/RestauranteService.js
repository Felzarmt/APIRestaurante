...
class RestauranteService {
    static registro(restaurante) {
        return __awaiter(this, void 0, void 0, function* () {
            restaurante.password = yield (0, gerenateHash_1.default)(restaurante.password);
            return yield RestauranteRepositorio_1.default.agregar(restaurante);
        });
    }
}
